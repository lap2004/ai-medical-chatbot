  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center bg-slate-50 dark:bg-slate-950/20">
      <div className="relative mb-8">
        ...
        <div className="relative w-32 h-32 rounded-full border-4 border-white dark:border-slate-700 shadow-2xl overflow-hidden bg-primary/10">
          <img 
            alt="Voice Avatar" 
            className="w-full h-full object-cover" 
            src="https://picsum.photos/seed/rebecca2/200/200" 
          />
        </div>
      </div>
