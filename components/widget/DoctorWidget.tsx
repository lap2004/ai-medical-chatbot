...
export const DoctorWidget: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <div className="fixed bottom-28 right-8 w-full max-w-[380px] h-[580px] bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 flex flex-col z-[100] animate-in fade-in slide-in-from-bottom-4 duration-300">
