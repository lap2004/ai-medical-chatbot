    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#/chat" className="text-sm font-medium hover:text-primary transition-colors">ChatAI</a>
              <a href="#" className="text-sm font-medium hover:text-primary transition-colors">Hỗ trợ</a>
              <button 
              ...
              <a href="#/login" className="bg-primary hover:bg-teal-700 text-white px-6 py-2.5 rounded-full font-semibold transition-all shadow-lg shadow-teal-700/20">Sign In</a>
            </div>
          </div>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed max-w-xl">
                Experience immediate medical guidance, symptom checks, and medication info powered by advanced AI.
              </p>
              <div className="flex flex-wrap gap-4">
                <a href="#/chat">
                  <Button size="lg" className="px-10">Get Started Free <span className="material-icons-round ml-2">arrow_forward</span></Button>
                </a>
                <Button variant="outline" size="lg" className="px-10">
                  <span className="material-icons-round text-primary mr-2">play_circle</span> Watch Demo
                </Button>
              </div>
            </div>
               ...
               <div className="relative w-full max-w-md bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-700 overflow-hidden transform rotate-2 z-10 floating">
                  <div className="p-6 bg-primary text-white flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <img src="https://picsum.photos/seed/doc/100/100" className="w-10 h-10 rounded-full border-2 border-white/20" alt="" />
                      <div>
                        <h4 className="font-bold text-sm">Rebecca AI</h4>
                        <p className="text-[10px] opacity-70">Medical Assistant</p>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-24 bg-white dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4 dark:text-white">Smart Healthcare Solutions</h2>
          <p className="text-slate-500 mb-16 max-w-2xl mx-auto">Trained on millions of clinical papers to provide accurate health information.</p>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: 'chat', title: 'Instant Consultation', desc: 'Chat with our AI anytime for immediate answers.' },
              { icon: 'mic', title: 'Voice Interaction', desc: 'Speak naturally for hands-free guidance.' },
              { icon: 'history', title: 'Health Tracking', desc: 'Securely store and track your history.' },
            ].map((sol, i) => (
              <div key={i} className="p-8 rounded-3xl border border-slate-100 dark:border-slate-800 hover:border-primary transition-all group bg-white dark:bg-slate-900 shadow-sm">
                ...
                <h3 className="text-xl font-bold mb-4 dark:text-white">{sol.title}</h3>
