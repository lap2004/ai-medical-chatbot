...
export const TriageCard: React.FC<TriageProps> = ({ questions, suggestedAnswers, onSelect }) => {
  return (
    <div className="bg-white dark:bg-slate-800 p-6 shadow-sm border border-slate-100 dark:border-slate-700 rounded-3xl rounded-tl-none max-w-xl animate-in slide-in-from-left-4 duration-500">
      ...
      <div className="space-y-3 mb-6">
        {questions.map((q, i) => (
          <div key={i} className="flex items-center space-x-3 text-sm bg-slate-50 dark:bg-slate-900/50 p-3 rounded-xl border border-slate-100 dark:border-slate-700">
