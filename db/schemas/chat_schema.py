...
# # Schema I/O cho API chat (message-based).
# # """
...
# # =========================
# # RAG / Safety schemas (giữ lại để dùng trong rag_context / response)
# # =========================
# class RetrievedContext(BaseModel):
#     medical_id: Optional[UUID] = None
#     doc_id: Optional[str] = None
...
# # =========================
# # (Optional) Legacy-like response nếu bạn vẫn muốn trả về "question/answer"
# # khi POST message chạy luôn RAG và tạo assistant message.
# # =========================
# class ChatTurnResponse(BaseModel):
#     """
#     Dùng nếu bạn muốn endpoint POST message trả về cả cặp user+assistant
#     (giống ChatResponse cũ), nhưng align theo message schema.
#     """
#     conversation_id: UUID
#     user_id: int
